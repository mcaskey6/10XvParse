...
def tenx_whitelist(tech: str) -> str:
    """The 10x cell-barcode whitelist for a tech (e.g. 10XV3), used by STARsolo.
    Generated by the tenx_whitelist rule from kb-python's bundled copy, so it is not
    committed — it lives under Generated/ like the other rebuildable files."""
    return f"Generated/10x_info/{tech}_whitelist.txt"
